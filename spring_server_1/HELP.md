...
* The original package name 'tech.kingoyster.spring-simple-server' is invalid and this project uses 'tech.kingoyster.springsimpleserver' instead.
...
```
$ docker run --rm -p 8080:8080 spring-simple-server:0.0.1-SNAPSHOT
```
